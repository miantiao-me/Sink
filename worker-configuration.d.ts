/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 52e36da120cb030479034e07c8154294)
...
interface __BaseEnv_Env {
	...
	DEPLOY_KV_PREVIEW_NAMESPACE_ID: string;
	NUXT_CF_ACCOUNT_ID: string;
	NUXT_CF_API_TOKEN: string;
	NUXT_PUBLIC_PREVIEW_MODE: string;
	NUXT_PUBLIC_SLUG_DEFAULT_LENGTH: string;
	NUXT_PUBLIC_KV_BATCH_LIMIT: string;
	NUXT_PUBLIC_MAX_URL_LENGTH: string;
	NUXT_PUBLIC_HOME_URL: string;
	NUXT_PUBLIC_LINK_PROXY_ENABLED: string;
	NUXT_API_CORS: string;
	DEPLOY_R2_BUCKET_NAME: string;
	DEPLOY_R2_PREVIEW_BUCKET_NAME: string;
	NUXT_NOT_FOUND_REDIRECT: string;
	NUXT_CF_ACCESS_TEAM_DOMAIN: string;
	NUXT_CF_ACCESS_AUD: string;
	NUXT_SAFE_BROWSING_DOH: string;
	NUXT_WEBHOOK_URL: string;
	NUXT_WEBHOOK_SECRET: string;
	NUXT_REDIRECT_STATUS_CODE: string;
	NUXT_LINK_CACHE_TTL: string;
	NUXT_REDIRECT_WITH_QUERY: string;
	NUXT_REDIRECT_NO_STORE: string;
	NUXT_CASE_SENSITIVE: string;
	NUXT_DATASET: string;
	NUXT_LIST_QUERY_LIMIT: string;
	NUXT_DISABLE_BOT_ACCESS_LOG: string;
	NUXT_DISABLE_AUTO_BACKUP: string;
	NUXT_AI_MODEL: string;
	NUXT_AI_PROMPT: string;
	NUXT_AI_OG_PROMPT: string;
	DEPLOY_D1_DATABASE_NAME: string;
	DEPLOY_ANALYTICS_DATASET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_SITE_TOKEN" | "DEPLOY_D1_DATABASE_ID" | "DEPLOY_KV_NAMESPACE_ID" | "DEPLOY_KV_PREVIEW_NAMESPACE_ID" | "NUXT_CF_ACCOUNT_ID" | "NUXT_CF_API_TOKEN" | "NUXT_PUBLIC_PREVIEW_MODE" | "NUXT_PUBLIC_SLUG_DEFAULT_LENGTH" | "NUXT_PUBLIC_KV_BATCH_LIMIT" | "NUXT_PUBLIC_MAX_URL_LENGTH" | "NUXT_PUBLIC_HOME_URL" | "NUXT_PUBLIC_LINK_PROXY_ENABLED" | "NUXT_API_CORS" | "DEPLOY_R2_BUCKET_NAME" | "DEPLOY_R2_PREVIEW_BUCKET_NAME" | "NUXT_NOT_FOUND_REDIRECT" | "NUXT_CF_ACCESS_TEAM_DOMAIN" | "NUXT_CF_ACCESS_AUD" | "NUXT_SAFE_BROWSING_DOH" | "NUXT_WEBHOOK_URL" | "NUXT_WEBHOOK_SECRET" | "NUXT_REDIRECT_STATUS_CODE" | "NUXT_LINK_CACHE_TTL" | "NUXT_REDIRECT_WITH_QUERY" | "NUXT_REDIRECT_NO_STORE" | "NUXT_CASE_SENSITIVE" | "NUXT_DATASET" | "NUXT_LIST_QUERY_LIMIT" | "NUXT_DISABLE_BOT_ACCESS_LOG" | "NUXT_DISABLE_AUTO_BACKUP" | "NUXT_AI_MODEL" | "NUXT_AI_PROMPT" | "NUXT_AI_OG_PROMPT" | "DEPLOY_D1_DATABASE_NAME" | "DEPLOY_ANALYTICS_DATASET">> {}
}
