/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: ff2eb55c8435acf31aad05ef1cc8ee09)
...
interface __BaseEnv_Env {
	...
	NUXT_LINK_PROXY_ENABLED: string;
