        ...
        'application/json': {
          schema: {
            ...
            properties: {
              ...
              cloakingAllowTopNavigation: { type: 'boolean', description: 'When cloaking is enabled, allow user-initiated top-level navigation (required for sites like Stripe Checkout that block iframes)' },
